...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $mat->setUsername("matthieudu18A");
        $mat->setActif($faker->randomElement([true,false]));
        $mat->setPlainPassword("arsonneaudu17A");
        ...
        //         $lannonce->setIdCreateur($this->utilisateurRepository->find(mt_rand(3, 15)));
        //         $lannonce->setIdDepartement($this->departementRepository->find(mt_rand(1, 2)));
        //         $lannonce->setIdCategorie($this->categorieRepository->find(mt_rand(9, 12)));
        //         $lannonce->setIntitule($tabIntitule[$i]);
        //         $lannonce->setDescription("Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting.");
